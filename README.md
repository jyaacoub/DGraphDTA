...
2. And if you want to skip the long time preparation, please directly download the contact map and msa files which we already generated from [files](https://drive.google.com/open?id=1rqAopf_IaH3jzFkwXObQ4i-6bUUwizCv); `wget "https://drive.google.com/u/0/uc?id=1rqAopf_IaH3jzFkwXObQ4i-6bUUwizCv&export=download&confirm=t&uuid=d5fc665f-ac35-400e-b706-2b2ae0aafaba&at=AKKF8vz2oS-kguGY-fD2i9Zx9VxE:1686774599678"`. For more detailed generating information, please refer to the "scripts.py". Then copy the corresponding two folders to each dataset dir. For example:  <br>
